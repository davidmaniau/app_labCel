...
include '../include/session.php';
  ...
  $titulo_pagina = "Cuentas por Cobrar - Facturas ";
  $titulo_modulo = "Cuentas por Cobrar - Facturas ";
...
//toda la data a mostrar en la tabla de registros previamente guardados
        ...
        while($row1 = $query->fetch_assoc()){
          ...
          IfNull(sum(".$tablax.".total),0) as totalr,
            ...
            IfNull( (select sum(monto) from ventas_detalle_abonos where ventas_detalle_abonos.venta_detalle_id = ".$row1['no_doc']." and ventas_detalle_abonos.tipo_doc_id = 2) ,0)

...
//toda la data a mostrar en la tabla de registros previamente guardados
       ...
       // $from = date('Y-m-d', strtotime('-15 day', strtotime($to)));
        ...
        while($row = $query->fetch_assoc()){  ?>
         ...
         $sql2x = "SELECT
         IfNull(sum(".$tablax.".total),0) as totalr, ".$tablax.".venta_id as empid2, ventas.id as empid,
          ...
          <tr>
            ...
            <?php if (number_format((($total_detalles+($total_detalles*0.15)) - $total_abonos),2) > 0 ) { ?>
              ...
              <td>
                ...
                <a style="color: white; margin-top: 0px;margin-bottom: 5px;" class="btn btn-success btn-sm "  href="<?php echo '../ventas_detalles_f/01index.php?d='.$doc1;  ?>"> <i class="fa fa-check"></i>  Detalles .. </a>

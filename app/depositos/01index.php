                  ...
                  <tbody>
                    ...
                    <?php  while($row = $query->fetch_assoc()){  ?>
                      <tr>
                        ...
                        <td><?php echo $row['numero_cuenta_deposito']; ?></td>
...
function getRow(id){
  ...
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_usuarios_id').val(response.usuarios_id);
...
$("#datepicker_edit").val(d + "-" + m + "-" + y);
      ...
      $('#edit_banco').val(response.banco);
      $('#edit_numero_cuenta').val(response.numero_cuenta_deposito);
      $('#edit_monto').val(response.monto);
      $('#edit_detalle').val(response.detalle);

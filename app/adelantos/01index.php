                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <div  class="btn-group-vertical"> 
                            ...
                            <button style="margin-top: 0px;margin-bottom: 05px;" class="btn btn-success btn-sm edit " data-id="<?php echo $row['idp'];  ?>" onclick = "funcionX(<?php echo $row['idp']; ?>)"><i class="fa fa-edit"></i> Editar</button>


                            <button style="margin-top: 0px;margin-bottom: 05px;" class="btn btn-danger btn-sm delete " data-id="<?php echo $row['idp']; ?>" onclick = "funcionY(<?php echo $row['idp']; ?>)"><i class="fa fa-trash"></i> Eliminar</button>
                          </div>
...
<script>
  ...
  function getRow(id){
    ...
    $.ajax({
      ...
      $('#edit_usuario_id').val(response.usuario_id);

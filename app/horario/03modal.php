    ...
    <div class="modal-content">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
             ...
             <select class="form-control" name="horarios_id" id="horarios_id" required>
              <option value="" selected>- Seleccionar -</option>
              <?php

              $sqla = "SELECT * FROM horarios where estado_registro = '1'";
              $querya = $conn->query($sqla);
              while ($prow = $querya->fetch_assoc()) {
                echo "<option value='".$prow['id']."'>". $prow['dias'] . "</option> ";
              }
              ?>
            </select>
          </div>
      ...
      <div class="bootstrap-timepicker">
        <div class="form-group">
          ...
          <input type="text" id="time_fi" value="<?php echo $hora_actual ?>" name="time_fi" data-toggle="datetimepicker" class="form-control datetimepicker-input" data-target="#timepicker11"/>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="05editar.php" method="post">
        ...
        <div class="bootstrap-timepicker">
         <div class="form-group">
          <label for="edit_time_in">Hora Entrada:</label>
    ...
    <div class="bootstrap-timepicker">
     <div class="form-group">
      <label for="edit_time_fi">Hora Salida:</label>
      ...
      <input type="text" id="edit_time_fi" name="time_fi" data-toggle="datetimepicker" class="form-control datetimepicker-input" data-target="#timepicker"/>

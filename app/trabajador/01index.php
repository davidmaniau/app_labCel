                  ...
                  <tbody>
                    <?php  while($row = $query->fetch_assoc()){  ?>
                      <tr>
                        ...
                        <td><?php echo $row['numero_cuenta_banco']; ?></td>
...
function getRow(id){
  ...
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_salario_mensual').val(response.salario_mensual);
      $('#edit_numero_cuenta_banco').val(response.numero_cuenta_banco);
      $('#edit_entrada').val(response.entrada);
      $('#edit_salida').val(response.salida);

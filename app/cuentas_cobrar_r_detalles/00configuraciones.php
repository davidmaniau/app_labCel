...
$titulo_pagina = "Cuenta por Cobrar - Detalle Recibo";
$titulo_modulo = "Cuenta por Cobrar - Detalle Recibo";
...
FROM ".$tabla."  
left join producto on producto.id = ".$tabla.".producto_id tipo_doc_id = 1
";

...
if ((($total_detalles+($total_detalles*0))-$total_abonos)>0) {
  // code...
}else{
 header('location: ../cuentas_cobrar_r/01index.php?');
}
            ...
            <div class="card">
              ...
              <div class="card-header">
                <div class="btn-group">
                  ...
                  <a style="margin-right: 10px " href="<?php echo '../cuentas_cobrar_r/01index.php';  ?>" class="btn btn-sm btn-danger"> <i class="fa fa-chevron-left"></i> Regresar </a>
                 ...
                 <div class="card-body">
                  <table id="example1_1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      where ".$tabla.".venta_id = ".$doc." and ".$tabla.".tipo_doc_id = 1";

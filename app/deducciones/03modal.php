      ...
      <form class="form-horizontal" action="04agregar.php" method="POST">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <select class="form-control select2"  id="usuarios_id" name="usuarios_id"  required>
        ...
        <div class="col-sm-9">
        <input type="text" class="form-control" onchange="cal()" onkeyup="cal()" id="monto" name="monto">
        </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="05editar.php" method="post">
        ...
        <div class="card-body">
         ...
         <div class="form-group row">
          <label for="edit_datepicker" class="col-sm-3 control-label" for="datepicker">Fecha</label>
          <div class="input-group date col-sm-9"  id="reservationdate" data-target-input="nearest">
            <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
              <div class="input-group-text"><i class="fa fa-calendar"></i></div>
            </div>
            <input type="text" id="edit_datepicker" name="fecha" class="form-control datetimepicker-input" data-target="#reservationdate"   data-toggle="datetimepicker"/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <select class="form-control select2" id="edit_usuarios_id"  name="usuarios_id"  required>
              <option value="" selected>- Seleccionar -</option>
              <?php
              $sqla = "SELECT * FROM usuarios where estado_registro = '1'";
              $querya = $conn->query($sqla);
        ...
        <div class="form-group row">
        <label for="edit_monto" class="col-sm-3 col-form-label">Monto</label>
        <div class="col-sm-9">
        <input type="text" class="form-control" onchange="cal()" onkeyup="cal()" id="edit_monto" name="monto">
        </div>
        </div>


          <div class="form-group row">
            <label for="edit_comentario" class="col-sm-3 control-label">Comentario</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" id="edit_comentario" name="comentario" required>
            </div>
          </div>

           ...
           <?php if ($total_pendiente>0){ ?>
             ...
             <tr>
              ...
              <td>
                ...
                <a style="color: white; margin-top: 0px;margin-bottom: 5px;" class="btn btn-success btn-sm "  href="<?php echo '../cuentas_cobrar_r_detalles/01index.php?d='.$doc1;  ?>"> <i class="fa fa-check"></i>  Detalles .. </a>

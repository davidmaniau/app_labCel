...
FROM ".$tablax."
where ".$tablax.".venta_detalle_id = ".$doc." and ".$tablax.".tipo_doc_id = 2";
$query2x = $conn->query($sql2x);
$row2x = $query2x->fetch_assoc();
...
if ((($total_detalles+($total_detalles*0.15))-$total_abonos)>0) {
  // code...
}else{
 header('location: ../cuentas_cobrar_f/01index.php?');
}
            ...
            <div class="card">
             ...
             <div class="card-header">
              <div class="btn-group">
                ...
                <a style="margin-right: 10px " href="<?php echo '../cuentas_cobrar_f/01index.php';  ?>" class="btn btn-sm btn-danger"> <i class="fa fa-chevron-left"></i> Regresar </a>

      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="04agregar.php" method="POST">
            ...
            <div class="modal-header">
              <h4 class="modal-title">Agregar Producto a la Fact</h4>
...
//SUBTOTAL---C
if (factor==39.37) {
  var area = parseFloat((altox*factor)*(ancho*factor));
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="card-body">
            <input type="hidden" class="empid" name="id">
            <input type="hidden"               name="tabla"  value="<?php echo $tabla; ?>">
            <input type="hidden"               name="modulo"  value="<?php echo '01index.php?d='.$doc; ?>">
...
<div class="modal fade" id="modal-abonar">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="card-body">
           <input type="hideen" value="<?php echo $doc; ?>" name="id">
           <input type="hideen" value="<?php echo $registro_venta; ?>" name="id3">
           <input type="hideen"               name="tabla"  value="<?php echo $tabla; ?>">
           <input type="hideen"               name="modulo"  value="01index.php?d=<?php echo $doc; ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="edit_monto" value="<?php echo number_format(($total_detalles+($total_detalles*0.15))-$total_abonos,2); ?>" readonly name="monto" required>
            </div>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="form-group row">
            <label for="edit_abono" class="col-sm-2 control-label">Abono</label>
            <div class="col-sm-10">
                <input type="text" value="<?php echo number_format(($total_detalles+($total_detalles*0.15))-$total_abonos,2); ?>" class="form-control"  step="any" readonly id="edit_abono" name="abono" required />
            </div>
        </div>

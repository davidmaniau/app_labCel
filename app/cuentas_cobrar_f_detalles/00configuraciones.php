...
$titulo_pagina = "Cuenta por Cobrar - Detalle Factura";
$titulo_modulo = "Cuenta por Cobrar - Detalle Factura";
...
FROM ".$tabla."  
left join producto on producto.id = ".$tabla.".producto_id and tipo_doc_id = 2
";

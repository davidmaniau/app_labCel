...
FROM ".$tablax." where ".$tablax.".venta_id = ".$doc." and ".$tablax.".tipo_doc_id = 2";
...
FROM ".$tablax." where ".$tablax.".venta_detalle_id = ".$doc." and ".$tablax.".tipo_doc_id = 2";
$query2x = $conn->query($sql2x);
$row2x = $query2x->fetch_assoc();
...
where ".$tabla.".venta_id = ".$doc." and ".$tabla.".tipo_doc_id = 2 and ventas.tipo_doc_id = 2 group by ".$tabla.".id";
$query3x = $conn->query($sql3x);
$row3x = $query3x->fetch_assoc();
$registro_venta=$row3x['empid2'];
$deuda = number_format(($total_detalles+($total_detalles*0.15))-$total_abonos,2);
            ...
            <div class="card">
             ...
             <div class="card-header">
              <div class="btn-group">
                ...
                <a style="margin-right: 10px " href="<?php echo '../ventas_factura/01index.php';  ?>" class="btn btn-sm btn-danger"> <i class="fa fa-chevron-left"></i> Regresar </a>


                <?php if (($total_detalles > 0) && ($deuda == 0)) {  //total_detalles = subtotal, deuda= saldo pendientes
                  ?>
                  
                  <a style="margin-right: 10px "  class="btn btn-sm btn-danger">  FACTURA CANCELADA </a>
...
<!-- INICIO CINTA DETALLES TOTALES -->
              ...
              <div class="col-sm-2 col-3">
                <div class="description-block border-right">
                 <h6 class="description-header text-warning">+$ <?php echo number_format( ($total_detalles*0.15),2); ?></h6>
             ...
             <div class="col-sm-2 col-3">
              <div class="description-block border-right">
                <h6 class="description-header text-success">$ <?php echo number_format($total_detalles+($total_detalles*0.15),2) ; ?></h6>
            ...
            <div class="col-sm-2 col-3">
              <div class="description-block">
                <h6 class="description-header text-danger">$ <?php echo number_format(($total_detalles+($total_detalles*0.15))-$total_abonos,2) ; ?></h6>
